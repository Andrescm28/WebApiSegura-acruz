    ...
    public class HabitacionController : ApiController
    {
        ...
        public IHttpActionResult GetId(int id)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"SELECT HAB_CODIGO, HOT_CODIGO, HAB_NUMERO, 
                                                            HAB_CAPACIDAD, HAB_TIPO, HAB_DESCRIPCION, HAB_ESTADO,HAB_PRECIO
                                                            FROM HABITACION WHERE HAB_CODIGO = @HAB_CODIGO", sqlConnection);
        ...
        private bool RegistrarHabitacion(Habitacion habitacion)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"INSERT INTO HABITACION (HAB_CODIGO, HOT_CODIGO, HAB_NUMERO, 
                                                            HAB_CAPACIDAD, HAB_TIPO, HAB_DESCRIPCION, HAB_ESTADO,HAB_PRECIO) VALUES (@HAB_CODIGO, @HOT_CODIGO, @HAB_NUMERO, 
                                                            @HAB_CAPACIDAD, @HAB_TIPO, @HAB_DESCRIPCION, @HAB_ESTADO, @HAB_PRECIO)", sqlConnection);
        ...
        private bool ActualizarHabitacion(Habitacion habitacion)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"UPDATE HABITACION SET
