    ...
    public class HotelController : ApiController
    {
        ...
        private bool RegistrarHotel(Hotel hotel)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"INSERT INTO HOTEL (HOT_NOMBRE, HOT_EMAIL, 
                                                            HOT_DIRECCION, HOT_TELEFONO, HOT_CATEGORIA) VALUES (@HOT_NOMBRE, @HOT_EMAIL, 
                                                            @HOT_DIRECCION, @HOT_TELEFONO, @HOT_CATEGORIA)", sqlConnection);
        ...
        private bool ActualizarHotel(Hotel hotel)
        {
            ...
            try
            {
                ...
                {
                    SqlCommand sqlCommand = new SqlCommand(@"UPDATE HOTEL SET
